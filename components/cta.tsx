    ...
    <section className="py-16 md:py-24 bg-[#151c28] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-xl max-w-2xl mx-auto mb-10 text-gray-300">
          Rejoignez des milliers de joueurs qui améliorent leurs performances
          grâce à l'analyse IA de leurs parties CS2.
        </p>
        ...
        <Button
          size="lg"
          className="button bg-gradient-to-r from-[#FF7700] to-[#FFAA00] hover:from-[#FF7700] hover:to-[#FF9900] text-black font-bold px-8"
        >
